...
namespace Lumora.Infrastructure.Migrations
{
    ...
    [Migration("20260923053344_AddedEmployeeInquiryDetails")]
    partial class AddedEmployeeInquiryDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lumora.Domain.Entities.Event.Gallery", b =>
                {
                    ...
                    b.Property<string>("GalleryCover")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Lumora.Domain.Entities.Event.Inquiry", b =>
                {
                    ...
                    b.ToTable("Inquiries", t =>
                        {
                            t.HasCheckConstraint("CK_Inquiry_QuotedAmount", "\"QuotedAmount\" >= 0 AND \"QuotedAmount\" <= 100000");
                        });
                });

            modelBuilder.Entity("Lumora.Domain.Entities.Event.InquiryEmployee", b =>
                {
                    b.Property<Guid>("InquiryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lumora.Domain.Entities.Event.InquiryEmployee", b =>
                {
                    b.HasOne("Lumora.Domain.Entities.Studio.Employee", "Employee")
                        .WithMany("Inquiries")
